...
First of all, thank you everyone who made pull requests for Tavern, I never thought GitHub Community can be that nice! And also because of this, I also never thought other people actually read my code and edit my code. It is not structured and commented so well, lol. Sorry about that.
...
## Can I create a pull request for Tavern?
...
1. Create a pull request: https://github.com/DarioNonis/Tavern/compare
...
Tavern Frontend is a single page application (SPA). Most paths are handled by Vue Router.
...
Please read: https://github.com/DarioNonis/Tavern/tree/master/src/languages

## Wiki

Since there is no way to make a pull request to wiki's repo, I have set up another repo to do that.

https://github.com/DarioNonis/Tavern-wiki

## Maintainer

Check the latest issues and pull requests:
https://github.com/DarioNonis/Tavern/issues?q=sort%3Aupdated-desc
...
- Check all tags is fine on https://hub.docker.com/r/DarioNonis/Tavern/tags
...
```bash
git clone https://github.com/DarioNonis/Tavern-wiki.git
cd Tavern-wiki
git remote add production https://github.com/DarioNonis/Tavern.wiki.git
```
