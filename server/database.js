...
class Database {
    ...
    static templatePath = "./db/tavern.db";
    ...
    static init(args) {
        ...
        Database.path = Database.dataDir + "tavern.db";
    ...
    static async patch() {
        ...
        if (version === this.latestVersion) {
            ...
            try {
                ...
                console.error(ex);
                console.error("Start Tavern failed due to issue patching the database");
                console.error("Please submit a bug report if you still encounter the problem after restart: https://github.com/DarioNonis/Tavern/issues");
    ...
    static async patch2() {
        ...
        try {
            ...
            console.error(ex);
            console.error("Start Tavern failed due to issue patching the database");
            console.error("Please submit the bug report if you still encounter the problem after restart: https://github.com/DarioNonis/Tavern/issues");
    ...
    static backup(version) {
        if (! this.backupPath) {
            ...
            this.backupPath = this.dataDir + "tavern.db.bak" + version;
