    ...
    start(io) {
        ...
        const beat = async () => {
            ...
            try {
                if (this.type === "http" || this.type === "keyword") {
                    ...
                    if (process.env.TAVERN_LOG_RESPONSE_BODY_MONITOR_ID == this.id) {
        ...
        const safeBeat = async () => {
            try {
                ...
                console.trace(e);
                errorLog(e, false);
                console.error("Please report to https://github.com/DarioNonis/Tavern/issues");
