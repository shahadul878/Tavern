...
const barkNotificationGroup = "Tavern";
const barkNotificationAvatar = "https://raw.githubusercontent.com/DarioNonis/Tavern/master/public/icon.png";
...
class Bark extends NotificationProvider {
    ...
    async send(notification, msg, monitorJSON = null, heartbeatJSON = null) {
        try {
            ...
            if (msg != null && heartbeatJSON != null && heartbeatJSON["status"] == UP) {
                let title = "Tavern Monitor Up";
                return await this.postNotification(title, msg, barkEndpoint);
            }

            if (msg != null && heartbeatJSON != null && heartbeatJSON["status"] == DOWN) {
                let title = "Tavern Monitor Down";
                return await this.postNotification(title, msg, barkEndpoint);
            }

            if (msg != null) {
                let title = "Tavern Message";
                return await this.postNotification(title, msg, barkEndpoint);
            }
    ...
    appendAdditionalParameters(postUrl) {
        ...
        // set icon to Tavern icon, 11kb should be fine
