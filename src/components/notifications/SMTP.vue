<template>
    <div>
        ...
        <div class="mb-3">
            ...
            <input id="from-email" v-model="$parent.notification.smtpFrom" type="text" class="form-control" required autocomplete="false" placeholder="&quot;Tavern&quot; &lt;example@Tavern.pet&gt;">
            <div class="form-text">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <input id="to-email" v-model="$parent.notification.smtpTo" type="text" class="form-control" autocomplete="false" placeholder="example2@Tavern.pet, example3@Tavern.pet" :required="!hasRecipient">
        </div>
