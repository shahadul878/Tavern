    ...
    <div>
        ...
        <Confirm ref="confirmDisableAuth" btn-style="btn-danger" :yes-text="$t('I understand, please disable')" :no-text="$t('Leave')" @yes="disableAuth">
            <template v-if="$i18n.locale === 'es-ES' ">
                ...
                <p>Es para <strong>quien implementa autenticación de terceros</strong> ante  como por ejemplo Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'pt-BR' ">
                ...
                <p>Isso é para <strong>alguém que tem autenticação de terceiros</strong> na frente do '' como o Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'de-DE' ">
                ...
                <p>Es ist für <strong>jemanden der eine externe Authentifizierung</strong> vor  geschaltet hat, wie z.B. Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'sl-SI' ">
                ...
                <p>Namenjen je <strong>nekomu, ki ima pred programom  vklopljeno zunanje preverjanje pristnosti</strong>, na primer Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'sr' ">
                ...
                <p>То је за <strong>оне који имају додату аутентификацију</strong> испред  као на пример Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'sr-latn' ">
                ...
                <p>To je za <strong>one koji imaju dodatu autentifikaciju</strong> ispred  kao na primer Cloudflare Access.</p>
            ...
            <template v-if="$i18n.locale === 'hr-HR' ">
                ...
                <p>To je za <strong>korisnike koji imaju vanjsku autentikaciju stranice</strong> ispred Tavern, poput usluge Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'tr-TR' ">
                ...
                <p>Bu, 'nın önünde Cloudflare Access gibi <strong>üçüncü taraf yetkilendirmesi olan</strong> kişiler içindir.</p>
                <p>Lütfen dikkatli kullanın.</p>
            </template>

            <template v-else-if="$i18n.locale === 'ko-KR' ">
                <p>정말로 <strong>인증 기능을 끌까요</strong>?</p>
                <p>이 기능은 <strong>Cloudflare Access와 같은 서드파티 인증</strong>을  앞에 둔 사용자를 위한 기능이에요.</p>
                <p>신중하게 사용하세요.</p>
            </template>

            <template v-else-if="$i18n.locale === 'pl' ">
                <p>Czy na pewno chcesz <strong>wyłączyć autoryzację</strong>?</p>
                <p>Jest przeznaczony dla <strong>kogoś, kto ma autoryzację zewnętrzną</strong> przed , taką jak Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'it-IT' ">
                ...
                <p><strong>Questa opzione è per chi un sistema di autenticazione gestito da terze parti</strong> messo davanti ad , ad esempio Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'id-ID' ">
                ...
                <p>Ini untuk <strong>mereka yang memiliki autentikasi pihak ketiga</strong> diletakkan di depan , misalnya akses Cloudflare.</p>
            ...
            <template v-else-if="$i18n.locale === 'ru-RU' ">
                ...
                <p>Это подходит для <strong>тех, у кого стоит другая авторизация</strong> перед открытием , например Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'bg-BG' ">
                ...
                <p>Използва се в случаите, когато <strong>има настроен алтернативен метод за удостоверяване</strong> преди , например Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'hu' ">
                ...
                <p>Akkor érdemes, ha <strong>van 3rd-party hitelesítés</strong> az -t megelőzően mint a Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'nb-NO' ">
                ...
                <p>Dette er for <strong>de som har tredjepartsautorisering</strong> foran , for eksempel Cloudflare Access.</p>
            ...
            <template v-else>
                ...
                <p>It is for <strong>someone who have 3rd-party auth</strong> in front of  such as Cloudflare Access.</p>
